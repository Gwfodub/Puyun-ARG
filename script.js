    ...
    */
    ...
    if (finalScore <= 11) {
        ...
        ending = {
            ...
            text:
                "很遗憾，您的回答与浦云大学附属中学的人才标准存在较大差异，我们相信，您已经尽力了。请不要将本次结果理解为对您个人价值的否定，我们只是选择了比您更适合的人。",
    ...
    /* =====================================================
       ...
       ===================================================== */
        ...
        ending = {
            ...
            text:
                "您的选择显示，您高度重视教学效率、学业表现、竞争能力以及教育资源的有效配置。您能够接受通过持续评价和绩效机制识别学生与教师的发展表现。请等待我们的联系。",
