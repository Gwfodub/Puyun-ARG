...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (!welcomePage) {
        console.error("找不到 welcomePage");
        return;
    }

    if (!questionPage) {
        console.error("找不到 questionPage");
        return;
    }

    if (!startButton) {
        console.error("找不到 startButton");
        return;
    }

    if (!nextButton) {
        console.error("找不到 nextButton");
        return;
    }

    if (!questionNumber) {
        console.error("找不到 questionNumber");
        return;
    }

    if (!questionTitle) {
        console.error("找不到 questionTitle");
        return;
    }

    if (!questionContent) {
        console.error("找不到 questionContent");
        return;
    }
